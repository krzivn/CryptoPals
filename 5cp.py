...
chall = '''Burning 'em, if you ain't quick and nimble
I go crazy when I hear a cymbal'''
...
#Just a little exercise to make a real stream out of possible whitespace crap, but ninjas use re
target = ''.join(target.split())

rawsol = XORcycle(chall, key)

solution = binascii.b2a_hex(rawsol)
